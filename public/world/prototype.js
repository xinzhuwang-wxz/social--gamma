...
function render() {
  ...
  document.querySelector("#app").innerHTML = `<div class="app-shell"><div class="phone">${page()}${ui.loading ? `<div class="loading"><i></i><span>小羊正在跑腿…</span></div>` : ""}${ui.toast ? `<div class="toast">${escapeHtml(ui.toast)}</div>` : ""}</div><aside class="demo-guide"><span>社交森林 · Campus Sandbox</span><h2>花园不是首页，<br>花园就是世界。</h2><p>场景内导航</p><ol><li>点击房子进入小羊的生活空间</li><li>点击信箱读取三封行动邀约</li><li>点击花圃种下愿望或查看成长</li><li>点击人物头像进入对方花园</li><li>行动完成后，植物进入回忆林</li></ol><small>当前人物、邀约和共同经历包含用于演示的模拟内容；所有发布与选择仍由真人确认。</small></aside></div>`;
